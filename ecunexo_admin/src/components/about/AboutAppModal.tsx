      ...
      <div className="ecu-about-modal">
        ...
        <div className="ecu-about-modal__changelog">
          <div className="ecu-about-modal__changelog-header">
            ...
            <span>Novedades v{APP_VERSION_INFO.version} — Reasignación Flexible de Variantes con Auditoría Inmutable y Presets de Calcetería</span>
          </div>
          <ul className="ecu-about-modal__changelog-list">
            <li><strong>Reasignación Flexible de Variantes con Auditoría Inmutable y Presets de Calcetería [v0.38.0]:</strong> Nueva funcionalidad para mover y reasignar variantes hijas entre productos matriz o independizarlas como productos individuales sin alterar su SKU físico, facturación previa ante el SRI ni el stock real en bodega (unidades físicas y kárdex preservados). Registro inmutable de trazabilidad en JSONB (<code style={{ fontSize: '0.8rem' }}>parent_reassignment_history</code>) con motivo de auditoría obligatorio, usuario y fecha UTC. Banner contextual con acción rápida en ficha de variante, botón de reasignación directa en la grilla de variantes del padre, y tarjeta de línea de tiempo con historial completo de movimientos. Adicionalmente, incorporación de presets en 1 clic para arquetipos de calcetería (Calcetería Deportiva & Técnica 3N, Calcetines de Diseño & Urbanos 3N, Packs & Boxes Multipack 2N) en el constructor de plantillas.</li>
