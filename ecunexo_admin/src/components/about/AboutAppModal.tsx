      ...
      <div className="ecu-about-modal">
        ...
        <div className="ecu-about-modal__changelog">
          <div className="ecu-about-modal__changelog-header">
            ...
            <span>Novedades v{APP_VERSION_INFO.version} — Líneas Vacías Automáticas y Presets de Fechas KPI</span>
          </div>
          <ul className="ecu-about-modal__changelog-list">
            <li><strong>Línea Vacía Automática en Facturación y Omitido en Cálculos:</strong> Garantía de generación automática de una fila en blanco al pie al agregar productos o escribir detalles en la última fila, permitiendo una carga fluida. Las líneas vacías son ignoradas automáticamente en cálculos de subtotal, IVA, total, vista previa y transmisión SRI.</li>
