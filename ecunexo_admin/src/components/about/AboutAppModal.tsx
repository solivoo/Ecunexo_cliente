      ...
      <div className="ecu-about-modal">
        ...
        <div className="ecu-about-modal__changelog">
          <div className="ecu-about-modal__changelog-header">
            ...
            <span>Novedades v{APP_VERSION_INFO.version} — Motor de Correos Electrónicos (Zoho Mail / SMTP) Centralizado en Base de Datos</span>
          </div>
          <ul className="ecu-about-modal__changelog-list">
            <li><strong>Motor de Correos Electrónicos (Zoho Mail / SMTP) y Configuración Centralizada en Base de Datos:</strong> Implementación del motor transaccional SMTP con MailKit (soporte nativo SSL en puerto 465 y STARTTLS en puerto 587) y almacenamiento dinámico en PostgreSQL (platform.sys_settings) con alcance global para todas las empresas. Nueva sección en Preferencias del Sistema (/app/configuracion) con preajuste inteligente para Zoho Mail, diagnóstico de envío en tiempo real y variables de entorno desacopladas para Portainer.</li>
