      ...
      <div className="ecu-about-modal">
        ...
        <div className="ecu-about-modal__changelog">
          <div className="ecu-about-modal__changelog-header">
            ...
            <span>Novedades v{APP_VERSION_INFO.version} — Tags Jerárquicos en Catálogo, Variantes Dimensionales y Limpieza de Interfaz</span>
          </div>
          <ul className="ecu-about-modal__changelog-list">
            <li><strong>Tags Jerárquicos en Catálogo, Variantes Dimensionales y Limpieza de Interfaz [v0.37.0]:</strong> Incorporación del nuevo componente de etiquetas interactivas (<code style={{ fontSize: '0.8rem' }}>EcuTagInput</code>) con chips visuales, sugerencias de categoría y atributos, y herencia automática de tags hacia las variantes físicas. Soporte de variantes dimensionales con identificador secuencial jerárquico (<code style={{ fontSize: '0.8rem' }}>PADRE-0001</code>), columna de Actividad / Uso y visualización en tiempo real de los tags acumulados por SKU en el constructor de matriz. Eliminación completa de plantillas de prueba y presets mock para una interfaz limpia donde cada empresa crea sus propios casos y arquetipos desde cero.</li>
