...
export function SriIdentityCard({
  ...
  return (
    <CompanyLegalFields
      ...
      hint={
        disabled || !onChange
          ? 'Identidad de la empresa en solo lectura. El titular la edita en el listado de empresas.'
          : 'Identidad legal de la empresa. Al guardar se sincroniza con la ficha y con Billing.'
      }
  ...
  return (
    <section className="app-shell__card ecu-companies-form__card">
      ...
      <p className="ecu-companies-form__hint">
        Número de la próxima factura: establecimiento-punto-secuencial (ej. 001-001-000000020).
        Deben coincidir con catastro SRI / celcer.
      </p>
