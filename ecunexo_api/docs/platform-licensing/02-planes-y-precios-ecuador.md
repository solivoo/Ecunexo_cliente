...
|------|----------------|----------|----------|----------|---------|---------|------------|---------|----------------|
| **Independiente** | `pro-independiente` | M0 servicio | 1 | 2 | 0 | identity + catalog + facturación (purchases opcional) | Cloud | 27 | 275 |
| **Local** | `local-comercio` | M1 comercio | 1 | 3 | 1 | + inventario + bodega + purchases (Tier Small) | Cloud | 42 | 428 |
| **Taller** | `taller-mixto` | M1–M2 mixto | 1 | 5 | 2 | iguales a Local + repairs + purchases (Tier Small/Medium) | Cloud | 59 | 602 |
| **Empresa** | `empresa-pyme` | M2 PyME | 1 | 10 | 3 | iguales + purchases (Tier Medium) | Cloud | 79 | 806 |
| **Cadena** | `cadena-retail` | M3 varios locales | 1 | 20 | 8 | iguales + purchases (Tier Big) | Cloud | 129 | 1 315 |
| **Grupo** | `grupo-multi-ruc` | M4 varios RUC | 5 | 25 | 10 | iguales por empresa + purchases (Tier Enterprise) | Cloud | 199 | 2 030 |
