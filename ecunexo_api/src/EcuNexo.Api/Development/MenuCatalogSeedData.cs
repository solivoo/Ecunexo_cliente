...
internal static class MenuCatalogSeedData
{
    ...
    [
        ...
        ("contabilidad.balances.read", "Balances — lectura", "Ver balances", "contabilidad", 95),
        ("contabilidad.declaraciones.read", "Declaraciones — lectura", "Ver declaraciones", "contabilidad", 96),
        ("contabilidad.cuentas.read", "Cuentas — lectura", "Ver cuentas contables", "contabilidad", 97),
        ("contabilidad.cuentas.manage", "Cuentas — gestionar", "Crear y editar cuentas y auxiliares", "contabilidad", 98),
        ("contabilidad.reportes.read", "Reportes contables — lectura", "Ver reportes contables", "contabilidad", 99),
        ("contabilidad.configuracion.read", "Config. contabilidad — lectura", "Ver configuración contable", "contabilidad", 100),
        ...
        ("purchases.expenses.read", "Categorías de compra — consultar", "Listar conceptos de compra, tipos de gasto ATS y sustentos SRI", "purchases", 157),
        ("purchases.expenses.manage", "Categorías de compra — administrar", "Configurar catálogo de conceptos, retenciones AIR y vigencias", "purchases", 158),
        ...
        ("purchases.manage", "Compras — administración total", "Control total sobre configuración y operaciones del módulo de compras", "purchases", 161),
    ];
    ...
    [
        ...
        Item("catalog", null, "Catálogo", "inventory_2", null, 50, MenuContextKind.Operational, "catalog", ["catalog.item.read", "catalog.matrix.read"]),
        ...
        Item("configuracion-sistema", "configuracion", "Preferencias y Sistema", "sliders-horizontal", "app/configuracion", 3, MenuContextKind.Operational, "identity", ["tenancy.tenant.read", "platform.settings.read"]),
        ...
        Item("sub-settings", "sub-org", "Configuración del sistema", "settings", "app/configuracion", 4, MenuContextKind.Subscription, "identity", ["tenancy.tenant.read", "platform.settings.read"]),
    ];
