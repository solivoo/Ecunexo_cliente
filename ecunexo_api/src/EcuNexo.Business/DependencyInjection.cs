...
public static class DependencyInjection
{
    public static IServiceCollection AddBusiness(this IServiceCollection services, IConfiguration? configuration = null)
    {
        ...
        services.AddScoped<IQueryHandler<ListVariantDimensionTemplatesQuery, IReadOnlyList<VariantDimensionTemplateResponse>>, ListVariantDimensionTemplatesHandler>();
        services.AddScoped<IQueryHandler<ListProductTemplatesQuery, IReadOnlyList<ProductTemplateResponse>>, ListProductTemplatesHandler>();
        services.AddScoped<IQueryHandler<GetProductTemplateByIdQuery, ProductTemplateResponse>, GetProductTemplateByIdHandler>();
