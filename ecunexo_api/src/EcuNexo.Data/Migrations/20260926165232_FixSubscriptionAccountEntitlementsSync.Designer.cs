...
namespace EcuNexo.Data.Migrations
{
    ...
    [Migration("20260926165232_FixSubscriptionAccountEntitlementsSync")]
    partial class FixSubscriptionAccountEntitlementsSync
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcuNexo.Core.Catalog.CatalogItem", b =>
                {
                    ...
                    b.Property<string>("HierarchyPathJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("hierarchy_path_json");
                    ...
                    b.HasIndex("FamilyId")
                        .HasDatabaseName("ix_items_family_id");

                    b.HasIndex("HierarchyPathJson")
                        .HasDatabaseName("ix_items_hierarchy_path_json");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("HierarchyPathJson"), "gin");
                    ...
                    b.HasIndex("TenantId", "FamilyId")
                        .HasDatabaseName("ix_items_tenant_id_family_id")
                        .HasFilter("\"deleted_at\" IS NULL");
            ...
            modelBuilder.Entity("EcuNexo.Core.Tenancy.SubscriptionAccount", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastEntitlementsSyncAtUtc")
                        .HasColumnType("timestamptz")
                    ...
                    b.Property<int>("LicenseEntitlementsVersion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
            ...
            modelBuilder.Entity("EcuNexo.Core.Catalog.CatalogItem", b =>
                {
                    ...
                    b.HasOne("EcuNexo.Core.Catalog.ProductTemplate", null)
                        .WithMany()
                        .HasForeignKey("FamilyId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_items_product_templates_family_id");
