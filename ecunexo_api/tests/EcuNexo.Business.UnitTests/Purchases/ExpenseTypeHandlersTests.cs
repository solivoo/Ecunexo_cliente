...
public sealed class ExpenseTypeHandlersTests
{
    ...
    [Fact(DisplayName = "SeedDefaultExpenseTypesHandler inserta los 8 gastos SRI estándar cuando el conteo es 0")]
    public async Task Handle_SeedDefaultExpenseTypes_WhenCountIsZero_SeedsEightTypes()
    {
        // Arrange
        ...
        await _expenseTypes.Received(1).AddRangeAsync(
            Arg.Is<IEnumerable<ExpenseType>>(list => list.Count() == 8),
